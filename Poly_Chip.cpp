...
nt leftclip(int a[10][2],int v,int wxmin)
{
int i,t[10][2];
int k=0;
int x1,y1,x2,y2;
...
f((a[i][0] > wxmin && a[(i+1)%v][0] < wxmin) || (a[i][0] < wxmin &&
a[(i+1)%v][0] > wxmin))
{
x1=a[i][0];
y1=a[i][1];
...
f((a[i][0] < wxmax && a[(i+1)%v][0] > wxmax) || (a[i][0] > wxmax
&& a[(i+1)%v][0] < wxmax))
{
x1=a[i][0];
y1=a[i][1];
...
f((a[i][1] < wymax && a[(i+1)%v][1] > wymax) || (a[i][1] > wymax
&& a[(i+1)%v][1] < wymax))
{
x1=a[i][0];
y1=a[i][1];
...
f((a[i][1] > wymin && a[(i+1)%v][1] < wymin) || (a[i][1] < wymin &&
a[(i+1)%v][1] > wymin))
{
x1=a[i][0];
y1=a[i][1];
